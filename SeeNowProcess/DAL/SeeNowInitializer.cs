    ...
    public class SeeNowInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<SeeNowContext>
    {
        ...
        private void AddProblems(SeeNowContext context)
        {
            ...
            var Problems = new List<Problem>
            {
                ...
                new Problem {Title="My code works and I don't know why",        Description="I just clicked a few times, VS generated plenty of code and it works!... - but I don't know why...",   Importance=Importance.Important,Story=nextUserStory, Box=newProjectBoxes.Where(b=>b.Name=="New").First(),              CreationDate=new DateTime(2017,4,1, 3,2,0), Iteration=nextProjectIteration, Progress=50,  EstimatedTime=new TimeSpan(12,0,0)},
                new Problem {Title="My code doesn't work and I don't know why", Description="I tried to do a small refactor but it did broke everything! I cannot undo it and I beg for help.",     Importance=Importance.Critical, Story=nextUserStory, Box=newProjectBoxes.Where(b=>b.Name=="Assigned").First(),         CreationDate=new DateTime(2017,4,1, 4,0,0), Iteration=nextProjectIteration, Progress=100, EstimatedTime=new TimeSpan( 4,0,0)},
                ...
                new Problem {Title="My code works and I don't know why",        Description="I just clicked a few times, VS generated plenty of code and it works!... - but I don't know why...",   Importance=Importance.Important,Story=punkStoryUserStory, Box=interstellaProjectBoxes.Where(b=>b.Name=="New").First(),              CreationDate=new DateTime(2019,4,1, 3,2,0), Iteration=interstellaProjectIteration,Progress=50, EstimatedTime=new TimeSpan(12,0,0) },
                new Problem {Title="My code doesn't work and I don't know why", Description="I tried to do a small refactor but it did broke everything! I cannot undo it and I beg for help.",     Importance=Importance.Critical, Story=punkStoryUserStory, Box=interstellaProjectBoxes.Where(b=>b.Name=="Assigned").First(),         CreationDate=new DateTime(2019,4,1, 4,0,0), Iteration=interstellaProjectIteration,Progress=50, EstimatedTime=new TimeSpan( 4,0,0) },
